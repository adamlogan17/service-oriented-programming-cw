...
/**
 * <p>Java class for staffModuleCode.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="staffModuleCode">
 ...
 * 
 */
@XmlType(name = "staffModuleCode", namespace = "http://staffPackage/")
@XmlEnum
public enum StaffModuleCode {
    ...
    public static StaffModuleCode fromValue(String v) {
        for (StaffModuleCode c: StaffModuleCode.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
