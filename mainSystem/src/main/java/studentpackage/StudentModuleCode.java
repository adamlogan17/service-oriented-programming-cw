...
/**
 * <p>Java class for studentModuleCode.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="studentModuleCode">
 ...
 * 
 */
@XmlType(name = "studentModuleCode", namespace = "http://studentPackage/")
@XmlEnum
public enum StudentModuleCode {
    ...
    public static StudentModuleCode fromValue(String v) {
        for (StudentModuleCode c: StudentModuleCode.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
